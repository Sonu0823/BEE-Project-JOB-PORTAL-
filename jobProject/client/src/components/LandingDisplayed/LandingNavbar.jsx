...
const LandingNavbar = () => {
  ...
  return (
    <div className={`flex flex-wrap items-center justify-between px-4 py-3`}>
      <div>
        <p className="text-4xl p-4 font-extrabold LogoFinished bg-sky-500/100 hover:bg-gray-300 rounded-full border-4 border-indigo-200  border-x-indigo-500">
          JobHub <span className="font-extrabold text-blue-600 "></span>
        </p>
      </div>
      <div
